...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    [?php include_partial('<?php echo $this->getModuleName() ?>/form', array('<?php echo $this->getModelClass() ?>' => $<?php echo $this->getModelClass() ?>, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?]
  </div>
